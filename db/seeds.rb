...
# userstatuses
Userstatus.create(rate: 1600, footwork: 30, stamina: 30, service: 30, receive: 30, volley: 30, forehand: 30, backhand: 30, mental: 30, user_id: 2)
Userstatus.create(rate: 1600, footwork: 30, stamina: 30, service: 30, receive: 30, volley: 30, forehand: 30, backhand: 30, mental: 30, user_id: 3)
Userstatus.create(rate: 1600, footwork: 30, stamina: 30, service: 30, receive: 30, volley: 30, forehand: 30, backhand: 30, mental: 30, user_id: 4)
Userstatus.create(rate: 1600, footwork: 30, stamina: 30, service: 30, receive: 30, volley: 30, forehand: 30, backhand: 30, mental: 30, user_id: 5)
Userstatus.create(rate: 1600, footwork: 100, stamina: 50, service: 50, receive: 50, volley: 50, forehand: 50, backhand: 50, mental: 50, user_id: 6)
Userstatus.create(rate: 1600, footwork: 50, stamina: 100, service: 50, receive: 50, volley: 50, forehand: 50, backhand: 50, mental: 50, user_id: 7)
Userstatus.create(rate: 1600, footwork: 50, stamina: 50, service: 100, receive: 50, volley: 50, forehand: 50, backhand: 50, mental: 50, user_id: 8)
Userstatus.create(rate: 1600, footwork: 50, stamina: 50, service: 50, receive: 100, volley: 50, forehand: 50, backhand: 50, mental: 50, user_id: 9)
Userstatus.create(rate: 1600, footwork: 50, stamina: 50, service: 50, receive: 50, volley: 100, forehand: 50, backhand: 50, mental: 50, user_id: 10)
Userstatus.create(rate: 1600, footwork: 50, stamina: 50, service: 50, receive: 50, volley: 50, forehand: 100, backhand: 50, mental: 50, user_id: 11)
Userstatus.create(rate: 1600, footwork: 50, stamina: 50, service: 50, receive: 50, volley: 50, forehand: 50, backhand: 100, mental: 50, user_id: 12)
Userstatus.create(rate: 1600, footwork: 50, stamina: 50, service: 50, receive: 50, volley: 50, forehand: 50, backhand: 50, mental: 100, user_id: 13)
Userstatus.create(rate: 1600, footwork: 80, stamina: 80, service: 80, receive: 80, volley: 80, forehand: 80, backhand: 80, mental: 80, user_id: 14)
Userstatus.create(rate: 1600, footwork: 60, stamina: 60, service: 60, receive: 60, volley: 60, forehand: 60, backhand: 60, mental: 60, user_id: 15)
# artcles
